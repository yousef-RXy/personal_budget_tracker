...
@Component
public class ExpenseSummaryUtils {

  private final ExpenseRepository expenseRepository;

  public ExpenseSummaryUtils(ExpenseRepository expenseRepository) {
  ...
  private Long getTotalAmount(Long userId, LocalDate start, LocalDate end) {
    return Optional.ofNullable(
        expenseRepository.getTotalAmountByUserIdAndDateRange(userId, start, end)).orElse(0L);
  }
